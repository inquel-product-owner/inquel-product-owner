...
class CourseNotes extends Component {
    ...
    loadNotesData = async () => {
        await fetch(
            `${this.url}/student/sub/${this.subscriptionId}/course/${this.courseId}/chapter/${this.state.chapterId}/${this.state.topic_num}/notes/`,
            {
                method: "GET",
            ...
            this.props.course_data.units.forEach((data) => {
                ...
                if (data.chapters && data.chapters.length !== 0) {
                    data.chapters.forEach((item) => {
                        ...
                        if (item.chapter_id === this.state.chapterId) {
...
export default connect(mapStateToProps)(CourseNotes);
