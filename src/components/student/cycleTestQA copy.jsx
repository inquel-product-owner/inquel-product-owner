...
class CycleTestQA extends Component {
    ...
    render() {
        document.title = `${this.state.cycleTestItem.cycle_test_name} Exam - Student | IQLabs`;
        const sections =
            this.state.cycleTestItem.auto_test !== undefined
                ? this.state.cycleTestItem.auto_test
                : [];
                                ...
                                ? sections[
                                      ...
                                      return (
                                          <div
                                              ...
                                              key={index}
                                          >
                                              <button className="btn btn-light light-bg btn-sm border-0 shadow-sm mr-1 px-3 font-weight-bold-600">
                                                  {index <= 8
                                                      ? `0${index + 1}`
                                                      : index + 1}
                                              </button>
