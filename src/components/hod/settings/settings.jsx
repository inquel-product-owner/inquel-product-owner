...
import UpdateWatermark from "./watermark";
...
class HODSettings extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tab: "profile",
                ...
                <div className="row">
                    <div className="col-md-2 mb-2 mb-md-0 pr-md-0">
                        <div className="card h-100 settings">
                            ...
                            >
                                <i className="fas fa-image mr-2"></i> Watermark
                            </div>
                        </div>
                    </div>
...
export default connect(mapStateToProps)(HODSettings);
